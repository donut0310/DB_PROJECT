		...
		submitBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String str = "insert into Customers (licenseNum, name, address, phone, email)" + " VALUES (" + "'"
							+ licenseNum + "','" + name + "','" + address + "','" + phone + "','" + email + "')";
		...
		updateBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					conDB();
					stmt = con.createStatement();
					String str = "update Customers set address = " + "'" + address + "'," + "phone = " + "'" + phone
							+ "'," + "email = " + "'" + email + "' where licenseNum = " + "'" + licenseNum + "'";
					stmt.executeUpdate(str);
		...
		deleteBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					conDB();
					stmt = con.createStatement();
					stmt.executeUpdate("delete from Customers where licenseNum = " + "'" + licenseNum + "'");
				} catch (Exception e2) {
					System.out.println();
					System.out.println("쿼리 읽기 실패 :" + e2);
				} finally {
