...
public class Companies {
	...
	public void init(JPanel btnPn) {
		...
		JTextField input2 = new JTextField("회사명");
		JTextField input3 = new JTextField("주소");
		JTextField input4 = new JTextField("전화번호");
		JTextField input5 = new JTextField("담당자 이름");
		JTextField input6 = new JTextField("담당자 이메일");

		JTextField update1 = new JTextField("번호");
		JTextField update2 = new JTextField("회사명");
		JTextField update3 = new JTextField("주소");
		JTextField update4 = new JTextField("전화번호");
		...
		btnPn.setLayout(new GridLayout(3, 7));
		...
		updateBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					conDB();
					stmt = con.createStatement();
					String str = "update Companies set name = " + "'" + name + "'," + "address = " + "'" + address
